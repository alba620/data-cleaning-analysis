...
```{r}
selected.houses$heigth.clasification <- as.factor(case_when(
                          as.numeric(selected.houses$floor) <= mean(as.numeric(selected.houses$floor)) ~ "bajo",    
                          as.numeric(selected.houses$floor) > mean(as.numeric(selected.houses$floor))  ~ "alto"
                          )) 

villaverde.houses$heigth.clasification <- as.factor(case_when(
                          as.numeric(villaverde.houses$floor) <= mean(as.numeric(villaverde.houses$floor)) ~ "bajo",    
                          as.numeric(villaverde.houses$floor) > mean(as.numeric(villaverde.houses$floor))  ~ "alto"
                          )) 

salamanca.houses$heigth.clasification <- as.factor(case_when(
                          as.numeric(salamanca.houses$floor) <= mean(as.numeric(salamanca.houses$floor)) ~ "bajo",    
                          as.numeric(salamanca.houses$floor) > mean(as.numeric(salamanca.houses$floor))  ~ "alto"
                          )) 
```
...
```{r}
cheap.houses <- villaverde.houses[villaverde.houses$price.clasification == "barato",] %>% 
  full_join(salamanca.houses[salamanca.houses$price.clasification == "barato",])
expensive.houses <- villaverde.houses[villaverde.houses$price.clasification == "caro",] %>% 
  full_join(salamanca.houses[salamanca.houses$price.clasification == "caro",])
```

```{r}
small.houses <- villaverde.houses[villaverde.houses$m2.clasification == "pequeño",] %>% 
  full_join(salamanca.houses[salamanca.houses$m2.clasification == "pequeño",])
big.houses <- villaverde.houses[villaverde.houses$m2.clasification == "grande",] %>% 
  full_join(salamanca.houses[salamanca.houses$m2.clasification == "grande",])
```

```{r}
lower.floors.houses <- villaverde.houses[villaverde.houses$heigth.clasification == "bajo",] %>% 
  full_join(salamanca.houses[salamanca.houses$heigth.clasification == "bajo",])
upper.floors.houses <- villaverde.houses[villaverde.houses$heigth.clasification == "alto",] %>% 
  full_join(salamanca.houses[salamanca.houses$heigth.clasification == "alto",])
```
