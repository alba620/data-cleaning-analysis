...
Teniendo en cuenta la situación descrita, a partir de los datos inmobiliarios se pretende encontrar relaciones entre las **características físicas** de las viviendas, así como determinar posibles relaciones de dichas características con su **precio**. Además, intrínseco a los datos con los que se trabajará, otro de los objetivos será la comparación de la situación del mercado inmobiliario entre los **distritos** de Salamanca y Villaverde de Madrid.
...
Teniendo presente esta descripción inicial del *dataset*, se va a responder a las siguientes preguntas:
