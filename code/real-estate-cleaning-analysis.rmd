...
```{r rownames.print=FALSE, class.source = 'fold-hide'}
...
```{r, out.width="100%",out.height ="50%", class.source = 'fold-hide'}
...
```{r class.source = 'fold-hide', out.height="50%", out.width="100%"}
...
```{r class.source = 'fold-hide', fig.height=5, fig.width=10}
...
- Los **precios por metro cuadrado** son signficativamente mayores en el distrito de Salamanca que en el de Villaverde, con un nivel de confianza del 95% en el método. Esto confirma la hipótesis del proyecto, puesto que las fuentes consultadas tenían en cuenta los precios absolutos y no por metro cuadrado y era necesario verificar la suposición. 
