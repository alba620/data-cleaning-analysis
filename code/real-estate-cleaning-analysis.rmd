...
Se han cargado `r houses.raw.dim[1]` registros con `r houses.raw.dim[2]` campos asociados a cada registro. Se procede a mostrar los 10 primeros registros para comprobar la estructura del conjunto de datos:
...
unique(selected.houses$source)
```

Tanto el campo *location* como *source*
